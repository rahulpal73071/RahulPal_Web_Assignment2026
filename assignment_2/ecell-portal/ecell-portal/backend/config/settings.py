"""
Django Settings for E-Cell IIT Bombay Query Portal.
Split-ready: base settings here, override via env vars.
"""
import os
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("POSTGRES_DB", "ecell_db"),
        "USER": os.environ.get("POSTGRES_USER", "rahulpal"),
        "PASSWORD": os.environ.get("POSTGRES_PASSWORD", "rahul73071"),
